...
DSTDIR="../../build/Packager/Assets/Libraries/Bridge/Plugins/Android"
rm -rf "$DSTDIR"
mkdir -p "$DSTDIR"
cp -a bridge/build/outputs/aar/bridge-release.aar "$DSTDIR/Bridge.aar"
cp -a Bridge.aar.meta "$DSTDIR"
