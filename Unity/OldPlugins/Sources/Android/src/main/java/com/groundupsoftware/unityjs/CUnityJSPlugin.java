...
package com.groundupsoftware.bridge;
...
class CBridgePluginInterface {

    private static String TAG = "CBridgePluginInterface";

    private CBridgePlugin plugin;
    private String pluginID;


    public CBridgePluginInterface(CBridgePlugin plugin_)
    {
        plugin = plugin_;
    }
    ...
    public void call(final String method, final String message)
    {
        ...
        a.runOnUiThread(new Runnable() {public void run() {
            if (plugin.IsInitialized()) {
                CBridgePlugin.UnitySendMessage(plugin.pluginID, method, message);
            }
        }});
    }
...
public class CBridgePlugin {


    private static String TAG = "CBridgePlugin";
    ...
    private static HashMap<String, CBridgePlugin> plugins = new HashMap<String, CBridgePlugin>();
    private static final Object pluginLock = new Object();

    public String pluginID;
    private CustomWebView webView;
    private CBridgePluginInterface bridgePlugin;
    ...
    // Java_com_groundupsoftware_bridge_CBridgePlugin_SetUnitySendMessageCallback
    ...
    // Java_com_groundupsoftware_bridge_CBridgePlugin_GetRenderEventFunc
    public native static long GetRenderEventFunc();


    public CBridgePlugin()
    {
        ...
        a.runOnUiThread(new Runnable() {public void run() {
            ...
            webView.setWebChromeClient(new WebChromeClient() {
                ...
                public boolean onConsoleMessage(android.webkit.ConsoleMessage cm) {
                    ...
                    bridgePlugin.call("CallOnConsoleMessage", cm.message());
                    return true;
                }
            ...
            bridgePlugin =
                new CBridgePluginInterface(self);
            webView.addJavascriptInterface(bridgePlugin , "Unity");
            ...
            webView.setWebViewClient(new WebViewClient() {
                ...
                public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                    ...
                    bridgePlugin.call("CallOnError", errorCode + "\t" + description + "\t" + failingUrl);
                }
                ...
                public void onPageFinished(WebView view, String url) {
                    canGoBack = webView.canGoBack();
                    canGoForward = webView.canGoForward();
                    bridgePlugin.call("CallOnLoaded", url);
                }
                ...
                public boolean shouldOverrideUrlLoading(WebView view, String url) {
                    if (url.startsWith("http://") || 
                        ...
                        bridgePlugin.call("CallFromJS", message);
                        return true;
                    }
        ...
        activityRootView.getViewTreeObserver().addOnGlobalLayoutListener(new android.view.ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                if (heightDiff > size.y / 3) { // assume that this means that the keyboard is on
                    CBridgePlugin.UnitySendMessage(pluginID, "SetKeyboardVisible", "true");
                } else {
                    CBridgePlugin.UnitySendMessage(pluginID, "SetKeyboardVisible", "false");
                }
            }
        });
    }
        ...
        a.runOnUiThread(new Runnable() {public void run() {
            ...
            webView.evaluateJavascript(js, new ValueCallback<String>() {
                ...
                public void onReceiveValue(String result) {
                    ...
                    bridgePlugin.returnResult(result);
                }
            });
        }});
    }
    ...
    public static void RenderUpdateBridgePlugins()
    {
        //Log.d(TAG, "RenderUpdateBridgePlugins");
        synchronized (pluginLock) {

            for (CBridgePlugin plugin : plugins.values()) {
                plugin.RenderUpdate();
            }
    ...
    public void UpdateExternalSurface()
    {
        ...
        bridgePlugin.call("CallOnTexture", "");
    }
