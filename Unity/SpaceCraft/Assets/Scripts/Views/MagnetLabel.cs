...
public class MagnetLabel : MonoBehaviour
{
    [Header("References")]
    ...
    // Called when the magnet view is created or updated - more full configuration
    ...
    public void SetupLabel()
    {
        if (_titleText == null)
        {
            ...
            GameObject titleObj = new GameObject("Magnet_Text");
