            ...
            switch (command) {
                ...
                case "moveSplineLocal":
                    ...
                    if (data.ContainsKey("position")) {
                        ...
                        if (!BridgeJsonConverter.ConvertToType<Vector3>(data["position"], ref position)) {
                        ...
                        Vector3[] path = null;
                        if (!BridgeJsonConverter.ConvertToType<Vector3[]>(data["path"], ref path)) {
                        ...
                        if (!BridgeJsonConverter.ConvertToType<LTSpline>(data["spline"], ref spline)) {
                ...
                case "rotateLocal":
                    ...
                    if (!BridgeJsonConverter.ConvertToType<Vector3>(data["to"], ref rotateTo)) {
                ...
                case "rotateAroundLocal":
                    ...
                    if (!BridgeJsonConverter.ConvertToType<Vector3>(data["axis"], ref rotateAroundAxis)) {
                        Debug.LogError("LeanTweenBridge: AnimateData: to must be an Vector3. data: " + data);
                        return;
                    }
                ...
                case "scale":
                    ...
                    if (toToken.IsNumber()) {
                        ...
                        if (!BridgeJsonConverter.ConvertToType<Vector3>(toToken, ref to)) {
