...
console.log('  SPACECRAFT_CONTENT_SCHEMAS_DIR:', PATHS.SPACECRAFT_CONTENT_SCHEMAS_DIR);
console.log('  SPACECRAFT_GENERATED_SCHEMAS_DIR:', PATHS.SPACECRAFT_GENERATED_SCHEMAS_DIR);
console.log('  SPACECRAFT_SCHEMAS_DIR:', PATHS.SPACECRAFT_SCHEMAS_DIR); 