...
if (schemaFiles.length === 0) {
  ...
  console.log(`${EMOJI.INFO} Run 'npm run schemas:export' to generate schemas`);
} else {
...
if (!fs.existsSync(contentSchemasDir)) {
  ...
  console.log(`${EMOJI.INFO} Run 'npm run schemas:copy-to-content' to copy schemas`);
} else {
...
if (!fs.existsSync(unitySchemasDir)) {
  ...
  console.log(`${EMOJI.INFO} Run 'npm run schemas:copy' to copy schemas to Unity`);
} else {
