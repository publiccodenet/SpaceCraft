...
2. Copy them to `Unity/SpaceCraft/Assets/StreamingAssets/Content/schemas`
...
## Base Class
All generated schema classes inherit from `SchemaGeneratedObject` (in the `SpaceCraft` namespace), which provides:
...
Generated classes use the namespace `SpaceCraft.Schemas.Generated` and are inherited by our main classes in the `SpaceCraft` namespace.
